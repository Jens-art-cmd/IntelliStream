...
const STATES: Record<Status, {
  ...
  success: {
    ...
    body: "Sie erhalten ab jetzt Ihren personalisierten Newsletter. Wir destillieren täglich die wichtigsten Nachrichten aus Ihren Branchen — KI-kuratiert, impact-gewichtet.",
    cta: "Zum Feed →",
  ...
  already: {
    ...
    body: "Ihr Newsletter-Abonnement ist bereits aktiv. Sie erhalten weiterhin Ihren personalisierten Feed.",
  ...
  expired: {
    ...
    body: "Der Bestätigungslink ist nicht mehr gültig (24-Stunden-Frist überschritten). Bitte fordern Sie in den Einstellungen einen neuen Link an.",
  ...
  error: {
    ...
    body: "Bei der Bestätigung ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut oder kontaktieren Sie unseren Support.",
  ...
  unsubscribed: {
    ...
    body: "Sie haben sich vom DistillFeed Newsletter abgemeldet. Sie können sich jederzeit in Ihren Einstellungen wieder anmelden.",
    cta: "Zu den Einstellungen →",
    ctaHref: "/dashboard/settings",
  },
};
